...
title: "Haskell"
keywords: "Haskell, Learning Haskell, Functional Programming"
description: "Notes from Philip Hagenlocher on Youtube"
slug: "Haskell-Philip-Hagenlocher"
order: 4
---
...
- [Recursion](#recursion)
- [Guards - a different way of writing an if statement](#guards---a-different-way-of-writing-an-if-statement)
...
- [Higher Order Anonymous functions:](#higher-order-anonymous-functions)
- [Map](#map)
- [Filter](#filter)
- [Partial Function Application - Currying](#partial-function-application---currying)
...
- [Maybe](#maybe)
- [IO](#io)
  - [getLine action](#getline-action)
- [Type Inference](#type-inference)
- [Monads](#monads)
- [Infinite Lists](#infinite-lists)
  - [Data, Type, newtype](#data-type-newtype)
  - [Defining an alternative type](#defining-an-alternative-type)
